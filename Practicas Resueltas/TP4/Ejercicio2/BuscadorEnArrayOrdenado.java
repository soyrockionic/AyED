...
public class BuscadorEnArrayOrdenado {
    ...
    private static class Resultado {
        ...
        public Resultado(String descripcion, long iteraciones, double tiempo) {
        ...
        public String toString() {
            return "Resultado [descripcion='" + descripcion + "', iteraciones='" 
                                          + iteraciones + "', tiempo='" + tiempo + "']";
        }
    ...
    public static Resultado buscarlineal(String desc, int[] datos, int valor) {
        ...
        return new Resultado(desc, iter, (finTime - initTime)/1000.0);
    }
    ...
    public static void main(String[] args) {
        ...
        Resultado res = buscarlineal("Busqueda lineal valor:" + cantidadElementos, datos, 175000);
        System.out.println(res);

        res = buscarDicotomico("Busqueda dicotomica valor:" + cantidadElementos, datos, 175000);
        System.out.println(res);
    }
