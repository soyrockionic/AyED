...
un arbol general de String y retorna el String mas largo que se encuentre mas profundo
en el arbol, junto con el String debe retornar el numero de nivel en el que se encuentre
el mismo. Si hubiese mas de un String con la misma longitud maxima a igual profunddidad
debe retornar uno de ellos.
